...
//     gsap.fromTo(
//       Array.from(featuresRef.current.querySelectorAll(".feature-box")),
//       { opacity: 0, y: 50 },
//       {
//         opacity: 1,
//         y: 0,
...
//         document.querySelectorAll(".floating-diamond")
//       );
//       const heroImage = document.querySelector(".hero-tilt");
...
//       {/* Hero Section */}
//       <section ref={heroRef} className="hero-section position-relative py-5">
//         <div className="hero-overlay"></div>
//         <div className="container-fluid px-3 hero-content">
//           <div className="row align-items-center">
...
//               /> */}
//               <h1 ref={titleRef} className="display-4 luxury-text mb-3">
//                 Timeless <span className="gold-accent">Elegance</span>
//               </h1>
//               <p ref={subtitleRef} className="lead mb-3">
...
//               <button
//   ref={ctaRef}
//   className="btn btn-luxury btn-lg my-3"
//   onClick={() => navigate("/products")}
// >
//   Explore Collections
// </button>
...
//       <section className="py-5 bg-white">
//         <div className="container">
//           <h2 className="section-title luxury-text text-center mb-5">
...
//       <section className="py-5">
//         <div className="container">
//           <h3 className="luxury-text section-title text-center mb-4">
...
//         src="https://cdn.pixabay.com/animation/2024/02/22/14/56/14-56-03-65__480.png"
//         alt="Diamond1"
//         className="floating-diamond d-none d-md-block"
//       />
//       <img
//         src="https://cdn.pixabay.com/animation/2024/02/22/14/56/14-56-03-65__480.png"
//         alt="Diamond2"
...
//       <section ref={heroRef} className="hero-section position-relative py-5">
//         <div className="hero-overlay"></div>
//         <div className="row align-items-center flex-column-reverse flex-md-row min-vh-100">
//           {/* <div className="container-fluid px-3 hero-content        .    "> */}
...
//               </button>
//             </div>
//             <div className="col-md-6 col-sm-0    text-center">
//               <img
//                 ref={heroImgRef}
//                 src="https://motisonsjewellers.com/media/catalog/product/cache/fe952e4743f2e20a894361b53de9957c/t/r/treasure-_diamond_and_gold_bracelet_-kb500163.png"
//                 alt="Luxury Jewelry"
...
//           </h2>
//           <div ref={featuresRef} className="row">
//             <div className="col-md-4 text-center feature-box mb-4 px-2">
//               <div>
//                 <div className="display-1 gold-accent">💎</div>
//                 <h4 className="luxury-text">Premium Quality</h4>
//                 <p>Only the finest diamonds and precious metals</p>
